...
namespace DAL.Migrations
{
    ...
    [Migration("20250624051440_moreartiforappuser")]
    partial class moreartiforappuser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Entities.UserMangment.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Models.Entities.UserMangment.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Models.Entities.Rating", b =>
                {
                    ...
                    b.HasOne("Models.Entities.UserMangment.ApplicationUser", "User")
                        .WithMany("Ratings")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
